...
// disregard - need the [0] bc gebtn creates an array // document.getElementsByTagName('ul')[0].append(newItem)
...
editButton.addEventListener('click', editItem);
   ...
   // deleteButton = list.getElementsByTagName('button')
   // console.log(deleteButton)
  //  for (let i = 0; i < deleteButton.length; i++){
   // if(deleteButton[i].innerHTML = 'X'){
  //     deleteButton[i].setAttribute("class", "delete")
  //  }
